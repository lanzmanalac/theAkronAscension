...
<div class="page-container <?= $theme; ?>-theme">
    ...
    <main class="praise-main">
        <div class="praise-container">
            ...
            <!-- Praise Submission Form -->
            <section class="submission-section">
                <h2>Submit Your Own Praise for LeBron</h2>
                <form method="POST" class="praise-form">
                    <input type="hidden" name="action" value="post_praise">
                    <textarea name="praise" rows="4" placeholder="Write your praise here..." required></textarea>
